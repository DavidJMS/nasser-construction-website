      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-20">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 text-[14px] leading-relaxed mb-8 max-w-sm">
              ...
              Serving homeowners and builders with excellence since 2005.
            </p>

            <div className="flex gap-4">
              <a href="#" className="w-9 h-9 bg-white/5 hover:bg-gold-500 text-white flex items-center justify-center rounded-full transition-all duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 md:col-span-3 gap-8">
            <div>
              <h4 className="text-[14px] font-bold text-white mb-8">Company</h4>
              <ul className="space-y-4">
                {footerLinks.company.map((link) => (
                  <li key={link.label}>
                    <a href={link.href} className="text-gray-400 hover:text-white text-[13px] transition-colors">{link.label}</a>
                  </li>
                ))}
              </ul>
            </div>
            <div>
              <h4 className="text-[14px] font-bold text-white mb-8">Services</h4>
              <ul className="space-y-4">
            ...
            <div>
              <h4 className="text-[14px] font-bold text-white mb-8">Support</h4>
              <ul className="space-y-4">
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-[12px]">
            © 2026 Nasser Doors & Windows. All rights reserved.
          </p>
          <p className="text-gray-500 text-[12px] flex items-center gap-2">
