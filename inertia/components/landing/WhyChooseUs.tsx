...
import { Focus, Zap, ShieldCheck, Headphones } from 'lucide-react'

const features = [
  {
    icon: <Focus className="w-8 h-8 md:w-10 md:h-10" />,
    title: 'Perfect Fit',
  ...
  },
  {
    ...
    description:
      'Our team has in-depth technical knowledge of the latest technologies and trends.',
  },
  {
...
export default function WhyChooseUs() {
  ...
  // Use spring for a smoother, more premium feel
  ...
  // aggressive parallax range: move from -30% to 30% during scroll
  ...
  return (
    <section 
      id="why-choose" 
      ref={containerRef}
      className="relative py-20 overflow-hidden flex items-center min-h-[350px] bg-navy-950"
    >
