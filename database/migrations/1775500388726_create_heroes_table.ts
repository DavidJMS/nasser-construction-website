  ...
  async up() {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table
        .string('title')
        .nullable()
        .defaultTo('Custom-made doors and windows with professional installation')
      ...
      table.string('image_2').nullable().defaultTo('/images/hero-bg.png')
      table.string('image_3').nullable().defaultTo('/images/window-product.png')
